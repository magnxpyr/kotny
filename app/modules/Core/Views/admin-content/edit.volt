...
{#{% do assets.collection('header-css').addCss("https://cloud.tinymce.com/stable/skins/lightgray/content.min.css") %}#}
{#{% do assets.collection('header-css').addCss("https://cloud.tinymce.com/stable/skins/lightgray/skin.min.css") %}#}
