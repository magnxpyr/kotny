    ...
    <div class="box-header with-border">
        <div class="col-sm-6">
            <ul class="nav nav-pills">
                ...
                <li><button onclick="location.href='{{ url("admin/core/category/index") }}'" class="btn btn-sm btn-block btn-danger"><i class='fa fa-remove'></i> Cancel</button></li>
            </ul>
        </div>
    </div>
    <div class="box-body">
        {{ form.renderForm(
            url("admin/core/category/save"),
            [
                'form': ['id': 'menuForm'],
