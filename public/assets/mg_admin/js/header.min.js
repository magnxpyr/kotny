...
$(function($){$('.hint-block').each(function(){var $hint=$(this);$hint.parent().find('label').addClass('help').popover({html:true,trigger:'hover',placement:'right',content:$hint.html()});});});;'use strict';if(typeof jQuery==="undefined"){throw new Error("AdminLTE requires jQuery");}
